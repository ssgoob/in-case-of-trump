...
benjamin = User.create(name: "Benjamin", preference: 'F', gender: 'M')
karen = User.create(name: "Karen", preference: 'M', gender: 'F')
tito = User.create(name: "Tito", preference: 'F', gender: 'M')
sally = User.create(name: "Sally", preference: 'M', gender: 'F')
